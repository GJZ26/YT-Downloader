...
makeTmp(){
    ...
    export pathSave="${path[0]}"".mp4/" # Lo asignamos a las varibles globales para mayor comodidad
    export pathList="${path[1]}"
    ls "$pathSave" > ./.log.txt # La salida del comando ls será guardado en log.txt
